document.addEventListener('DOMContentLoaded', () => {
    ...
    const createNavButtons = (currentChapterId, storyId) => {
        ...
        if (currentIndex < story.chapters.length - 1) {
            ...
            endMarker.textContent = '故事已完結'; // 使用更簡單的提示
